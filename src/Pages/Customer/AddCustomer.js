...
import {Box, FormControl, OutlinedInput, FormLabel, Container, Paper} from '@mui/material';
import {RadioGroup, FormControlLabel, Radio, TextField} from '@mui/material';
import {Button, MenuItem} from "@material-ui/core";

import {useStyles} from "../../Assets/Styles/AddCustomerStyle";
import {userDataAction} from "../../store/Reducers/userDataReducer";
import {AddNewCustomer, editCustomerData} from "../../Middleware/CustomerApiCall";
...
const AddCustomer = () => {
    ...
    return (
        <Fragment>
            ...
            {showFeedback && <Index text={editMode ? "Edit detail Successfully" : "Add user successfully"}/>}
